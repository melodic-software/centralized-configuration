...
WORKDIR /src
COPY ["NuGet.config", "."]
COPY ["src/Configuration.API/Configuration.API.csproj", "./Configuration.API/"]
...
RUN dotnet publish "Configuration.API/Configuration.API.csproj" -c Release -o /app/publish /p:UseAppHost=false
