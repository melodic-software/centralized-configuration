    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigurationValueDataTypeId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigurationEntryTypeId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateModified = table.Column<DateTime>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbbreviatedDisplayName = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocalContextId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigurationEntryId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DomainId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ConfigurationEntryTypeId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConfigurationValueId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ConfigurationEntryId = table.Column<int>(type: "INTEGER", nullable: false),
                    ConfigurationValueDataTypeId = table.Column<int>(type: "INTEGER", nullable: true),
                    ApplicationId = table.Column<int>(type: "INTEGER", nullable: true),
                    EnvironmentId = table.Column<int>(type: "INTEGER", nullable: true),
                    LocalContextId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Environment",
                columns: new[] { "EnvironmentId", "AbbreviatedDisplayName", "DateCreated", "DateModified", "Description", "DisplayName", "DomainId", "IsActive", "UniqueName" },
                values: new object[,]
                {
                    { 1, null, new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Local", new Guid("fc52da1b-439a-4ffa-90f9-a9f7f585deb9"), true, "Local-fc52da1b" },
                    { 2, "Dev", new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Development", new Guid("69c89b3b-654c-4461-baad-bd4f115d8a11"), true, "Development-69c89b3b" },
                    { 3, "Test", new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Testing", new Guid("629e10af-8c7e-4b76-9e01-985e28a6a08c"), true, "Testing-629e10af" },
                    { 4, "Stage", new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Staging", new Guid("105c1e10-8701-43ca-a457-cd01f14591e5"), true, "Staging-105c1e10" },
                    { 5, "Prod", new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Production", new Guid("bf420f08-a3ec-4bf9-bb87-90dc04c4b6b9"), true, "Production-bf420f08" },
                    { 6, "Train", new DateTime(2023, 9, 29, 23, 0, 0, 0, DateTimeKind.Utc), null, null, "Training", new Guid("f2000413-1926-44f4-ba3f-19ca8b2da955"), false, "Training-f2000413" }
                });
